...
public abstract class ClienteMapper {
    ...
    @Mapping(target = "enderecos", ignore = true)
    @Mapping(target = "cartoes", ignore = true)
	public abstract MostrarClienteDTO clienteParaMostrarClienteDtoPaginaInicial(Cliente cliente, @Context FileStoragePerfilService fileStorageService);
    ...
    public Cliente cadastrarClienteDtoParaCliente(CadastrarClienteDTO clienteDTO) {
		...
		cliente.setCarrinho(new Carrinho(null, null, null, cliente));
		return cliente;
    }
