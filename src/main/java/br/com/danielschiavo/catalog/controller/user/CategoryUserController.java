...
public class CategoryUserController {
	...
	@Operation(summary = "Get all existing hierarchicaly")
	public ResponseEntity<?> getAllCategoriesHierarchical(){
		List<CategoryDto> allHierarchical = service.findAll();
	...
	public ResponseEntity<?> getCategoryById(@PathVariable Long categoryId){
		List<CategoryDto> allDto = service.getASpecificId(categoryId);
